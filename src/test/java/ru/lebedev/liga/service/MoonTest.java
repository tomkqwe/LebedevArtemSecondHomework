...
class MoonTest {
    ...
    void check_Day_Prediction_Need_to_Be_Tomorrow() {
        LocalDate date = new Moon(repository).getDayPrediction(eur,0).getDate();
    ...
    void check_Weeks_Predictions_First_Elements_Equals_Rest_Are_Not() {
        ArrayList<CurrencyModel> firstList = new Moon(repository).getWeekPrediction(eur);
        ArrayList<CurrencyModel> secondList = new Moon(repository).getWeekPrediction(eur);
    ...
    void checks_Dates_In_Month_Predictions() {
        List<CurrencyModel> monthPrediction = new Moon(repository).getMonthPrediction(eur);
